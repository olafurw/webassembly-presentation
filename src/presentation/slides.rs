...
use yew::prelude::{UseStateHandle, Html, html, function_component, use_context};
use yew_router::prelude::{use_history, History, Location};

use crate::presentation::routing::Page;
...
pub fn read_slides(slide_state: &UseStateHandle<Vec<String>>) {
